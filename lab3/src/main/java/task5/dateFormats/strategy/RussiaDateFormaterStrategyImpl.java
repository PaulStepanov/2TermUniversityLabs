...
public class RussiaDateFormaterStrategyImpl implements DateFormaterStrategy{
    private SimpleDateFormat dateFormat = new SimpleDateFormat(Countries.RUSSIA.getDateFormat());
